...
module.exports = function (sequelize, DataTypes) {
    const _hashPassword = function (user, options) {
    ...
    const User = sequelize.define(
        'User',
        {
            ...
            username: {
                ...
                allowNull: false,
                validate: { isLowercase: true, min: 4 }
            },
    ...
    User.prototype.canPlayRole = function (role) {
    ...
    User.prototype.hydrateRoles = function (callback) {
        ...
        Promise.all([findAdmin, findAccount]).then(
            (results) => {
                if (results[0]) {
    ...
    (User.generatePasswordHash = function (user, options, cb) {
